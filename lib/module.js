...
var __module = module.exports = exports = function (swift_)
{
 ...
 * @return {{}}
 */
__module.create = function (alias, callback)
{callback = _callback(callback);
    ...
    _jsmodule.reqDir(modelPath, true, function (result)
    {
        ...
        _jsmodule.reqDir(controllerPath, true, function (result)
        {
            if (result.status === 'error')
            {
