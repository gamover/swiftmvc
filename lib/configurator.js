...
__configurator.Configurator = function ()
{
    var self = this,
        ...
        pathToAppConfig = _path.normalize(__dirname + '/../../../app/config/config.json'),
        pathToSysConfig = __dirname + '/config.json',
    ...
    {
        var nsConfig = config[env] || config['development'] || {},
            extConfig = {};
