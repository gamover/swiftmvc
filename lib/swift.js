...
var _express = require('express'),
    ...
    modules = {},
    viewHelpers = _jsmodule.requireDirectory(__dirname + '/helpers/view') || {};
...
{
    //
    // задание основных путей приложения
    //
    ...
    //
    // инициализация помошника url
    //

    require('./helpers/url').init(_config.path.config + '/routes');
