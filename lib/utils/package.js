 ...
 * @returns {*}
 */
exports.require = function (pathToSource, params, callback)
{
    //
    ...
    $path.exists(pathToSource, function (exists)
    {
        if (!exists)
        {
            pathToSource += '.js';
 ...
 * @returns {*}
 */
exports.requireSync = function (pathToSource, params)
{
    //
    // обработка входных параметров
    //
    ...
    if (!$path.existsSync(pathToSource))
    {
        pathToSource += '.js';
        if (!$path.existsSync(pathToSource) || !$fs.statSync(pathToSource).isFile())
        {
            return;
        }
    }
 ...
 * @param {Function} callback
 */
exports.requireDir = function (pathToDir, params, callback)
{
    //
    // обработка входных параметров
    //
    ...
    $path.exists(pathToDir, function (exists)
    {
        if (!exists)
        {
 ...
 * @return {Object}
 */
exports.requireDirSync = function (pathToDir, params)
{
    //
    // обработка входных параметров
    //
    ...
    if (!$path.existsSync(pathToDir) || !$fs.statSync(pathToDir).isDirectory())
    {
        return {};
    }
 ...
 * @param {Function} callback
 */
exports.requireDirR = function (pathToDir, params, callback)
{
    //
    // обработка входных параметров
    //
 ...
 * @return {Object}
 */
exports.requireDirRSync = function (pathToDir, params)
{
    //
    // обработка входных параметров
    //
